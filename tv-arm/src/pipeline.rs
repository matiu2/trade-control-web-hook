...
mod tests {
    ...
    use crate::hs_resolve::{
        build_trade_spec, check_prep_expiries, check_required, hs_entry_level_vetos,
        prep_expiry_steps, round5, tp_resistance_band,
    };
    use crate::mw_resolve::{
        MwSpecAnchors, build_mw_trade_spec, check_mw_required, gate_neckline_pct,
